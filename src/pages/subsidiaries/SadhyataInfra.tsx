...
const SadhyataInfra = () => (
  <>
    <SEO
      ...
      description="Sadhyata Infra Limited is SADHYATA Group's infrastructure and mining flagship — civil construction, real estate development, and project execution across Jharkhand and India."
