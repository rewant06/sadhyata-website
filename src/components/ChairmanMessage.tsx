      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="lg:col-span-2 flex justify-center">
            <div className="w-64 h-80 bg-navy/5 border border-gold/20 flex items-center justify-center">
              <div className="text-center px-6">
                <div className="w-20 h-20 rounded-full bg-navy/10 mx-auto mb-4 flex items-center justify-center">
                  <span className="font-serif text-navy text-2xl font-bold">KS</span>
                </div>
                <span className="text-navy font-serif font-semibold text-sm">
          ...
          <div className="lg:col-span-3">
            ...
            <blockquote className="text-2xl md:text-3xl font-serif text-navy leading-snug mb-8 italic">
