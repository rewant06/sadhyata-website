      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-serif font-semibold text-navy mt-3 mb-6 leading-tight">
          ...
          <div className="grid grid-cols-2 gap-5">
            {[
              ...
              <div
                key={item.title}
                className="bg-card p-6 border border-border hover:border-gold/30 transition-colors"
              >
                <div className="text-2xl mb-3">{item.icon}</div>
                <h3 className="font-serif font-semibold text-navy text-sm mb-1">{item.title}</h3>
